...
## Example Usage
The embeddings represent nine colorectal tissue classes— adipose, background, debris, lymphocytes, mucus, smooth muscle, normal mucosa, cancer-associated stroma, and tumor epithelium—derived from 86 FFPE colorectal slides released by Kather, Halama, and Marx (2018) and processed using the foundation model introduced by Chen et al. (2024). The workflow is inspired by Chen et al. (2024).
