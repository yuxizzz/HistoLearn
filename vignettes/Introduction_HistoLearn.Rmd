...
we will evaluate the model on the our test set. `evaluate_model()` applies the fitted PCA model to the test embeddings, apply classifiers to generate predictions, computes accuracy, and returns a confusion-matrix plot.
