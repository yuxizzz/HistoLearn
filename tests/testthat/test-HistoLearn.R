# Purpose: integration test for the package
# Author: Yuxi Zhu
# Date: 2025-11-27
# Version: 0.1.0
# Bugs and Issues: None known.
# Note: Template for integration test script is generated by ChatGPT,
# then reviewed, refined, and fully customized by Yuxi Zhu.
