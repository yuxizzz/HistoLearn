...
The workflow diagram is drawn using BioRender and the example colorectal cancer H&E images are from Kather et al. (2018), where BACK represent class background, ADI represent class Adipose, DEB represent debris.
