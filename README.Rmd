...
- The example data and Shiny app demo datasets are derived from Kather et al. (2018) 
and were processed using the UNI pathology foundation model (Chen et al., 2024). 
The author performed all preprocessing steps to generate the example embeddings and 
